    ...
    return (
        <div className="sociallink">
            <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://t.me/LSSYAOfficial" aria-label="@lssya telegram" className="sc-eCssSg lbrsth sc-fodVxV cYLuAZ">
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="sc-gKsewC jBVRYk">
            ...
            <a target="_blank" rel="noopener" data-testid="SocialIcon" href="mailto:contact@lssya.app" aria-label="@lssya email address" className="sc-eCssSg lbrsth sc-fodVxV cYLuAZ">
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="sc-gKsewC jBVRYk">
            ...
            <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://www.instagram.com/lssyacounselling/" aria-label="@lssya instagram" className="sc-eCssSg lbrsth sc-fodVxV cYLuAZ">
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="sc-gKsewC jBVRYk">
